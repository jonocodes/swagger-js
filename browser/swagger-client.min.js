...
},{"_process":undefined,"lodash-compat/array/indexOf":50,"lodash-compat/lang/isPlainObject":146}],5:[function(require,module,exports){
"use strict";var helpers=require("./helpers"),request=require("superagent"),jsyaml=require("js-yaml"),_={isObject:require("lodash-compat/lang/isObject")},JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){var r;r=t&&t.client?t.client:new SuperagentHttpClient(t),r.opts=t||{};var s=!1;if("undefined"!=typeof window&&"undefined"!=typeof window.jQuery&&(s=!0),this.isInternetExplorer()&&(e.useJQuery===!1||!hasJquery))throw new Exception("Unsupported configuration! JQuery is required but not available");(e&&e.useJQuery===!0||this.isInternetExplorer()&&s)&&(r=new JQueryHttpClient(t));var n=e.on.response,o=function(e){return t&&t.requestInterceptor&&(e=t.requestInterceptor.apply(e)),e},a=function(e){return t&&t.responseInterceptor&&(e=t.responseInterceptor.apply(e)),n(e)};return e.on.response=function(e){a(e)},_.isObject(e)&&_.isObject(e.body)&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),r.execute(o(e)),e.deferred?e.deferred.promise:e},SwaggerHttp.prototype.isInternetExplorer=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=jQuery||window.jQuery,r=e.on,s=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var t={},n=e.getAllResponseHeaders().split("\n"),o=0;o<n.length;o++){var a=n[o].trim();if(0!==a.length){var u=a.indexOf(":");if(-1!==u){var p=a.substring(0,u).trim(),i=a.substring(u+1).trim();t[p]=i}else t[a]=null}}var l={url:s.url,method:s.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:t};try{var d=e.responseJSON||jsyaml.safeLoad(e.responseText);l.obj="string"==typeof d?{}:d}catch(y){helpers.log("unable to parse JSON/YAML content")}if(l.obj=l.obj||null,e.status>=200&&e.status<300)r.response(l);else{if(!(0===e.status||e.status>=400&&e.status<599))return r.response(l);r.error(l)}},t.support.cors=!0,t.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},n=request[t](e.url);for(r in s)n.set(r,s[r]);e.body&&n.send(e.body),"function"==typeof n.buffer&&n.buffer(),n.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var s,n={url:e.url,method:e.method,headers:r.headers};if(!t&&r.error&&(t=r.error),t&&e.on&&e.on.error){if(n.errObj=t,n.status=r?r.status:500,n.statusText=r?r.text:t.message,r.headers&&r.headers["content-type"]&&r.headers["content-type"].indexOf("application/json")>=0)try{n.obj=JSON.parse(n.statusText)}catch(o){n.obj=null}s=e.on.error}else if(r&&e.on&&e.on.response){var a;if(r.body&&Object.keys(r.body).length>0)a=r.body;else try{a=jsyaml.safeLoad(r.text),a="string"==typeof a?null:a}catch(o){helpers.log("cannot parse JSON/YAML content")}n.obj="object"==typeof a?a:null,n.status=r.status,n.statusText=r.text,s=e.on.response}n.data=n.statusText,s&&s(n)})};


},{"./helpers":4,"js-yaml":19,"lodash-compat/lang/isObject":145,"superagent":159}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){};Resolver.prototype.processAllOf=function(e,r,i,o,t){var s,n,l;r["x-resolved-from"]=["#/definitions/"+e];var f=r.allOf;for(f.sort(function(e,r){return e.$ref&&r.$ref?0:e.$ref?-1:1}),s=0;s<f.length;s++)l=f[s],n="/definitions/"+e+"/allOf",this.resolveInline(null,t,l,i,o,n)},Resolver.prototype.resolve=function(e,r,i,o){this.spec=e;var t,s,n=r,l=i,f=o;"function"==typeof r&&(n=null,l=r,f=i);var a=n;this.scope=f||this,this.iteration=this.iteration||0;var p,h,v,d,c=0,u={},y={},g=[];e.definitions=e.definitions||{};for(p in e.definitions){var O=e.definitions[p];for(d in O.properties)v=O.properties[d],_.isArray(v.allOf)?this.processAllOf(p,v,g,y,e):this.resolveTo(n,v,g,"/definitions");O.allOf&&this.processAllOf(p,O,g,y,e)}for(p in e.paths){var m,x,b;h=e.paths[p];for(m in h)if("$ref"===m)t="/paths"+p,this.resolveInline(n,e,h,g,y,t);else{x=h[m];var A=h.parameters||[],k=x.parameters||[];for(s in A){var j=A[s];k.unshift(j)}for(s in k){var j=k[s];if(t="/paths"+p+"/"+m+"/parameters","body"===j["in"]&&j.schema)if(_.isArray(j.schema.allOf)){for(var R="inline_model",p=R,$=!1,w=0;!$;){if("undefined"==typeof e.definitions[p]){$=!0;break}p=R+"_"+w,w++}e.definitions[p]={allOf:j.schema.allOf},delete j.schema.allOf,j.schema.$ref="#/definitions/"+p,this.processAllOf(p,e.definitions[p],g,y,e)}else this.resolveTo(n,j.schema,g,t);j.$ref&&this.resolveInline(n,e,j,g,y,j.$ref)}for(b in x.responses){var q=x.responses[b];t="/paths"+p+"/"+m+"/responses/"+b,_.isObject(q)&&(q.$ref&&this.resolveInline(n,e,q,g,y,t),q.schema&&this.resolveTo(n,q.schema,g,t))}}h.parameters=[]}var I,S=0,T=[],N=g;for(s=0;s<N.length;s++){var J=N[s];if(n===J.root){if("ref"===J.resolveAs){var D,H=((J.root||"")+"/"+J.key).split("/"),P=[],z="";if(J.key.indexOf("../")>=0){for(var U=0;U<H.length;U++)".."===H[U]?P=P.slice(0,P.length-1):P.push(H[U]);for(D=0;D<P.length;D++)D>0&&(z+="/"),z+=P[D];J.root=z,T.push(J)}else if(I=J.key.split("#"),2===I.length){(0===I[0].indexOf("http://")||0===I[0].indexOf("https://"))&&(J.root=I[0]),t=I[1].split("/");var E,Q=e;for(D=0;D<t.length;D++){var B=t[D];if(""!==B){if(Q=Q[B],"undefined"==typeof Q){E=null;break}E=Q}}null===E&&T.push(J)}}else if("inline"===J.resolveAs){if(J.key&&-1===J.key.indexOf("#")&&"/"!==J.key.charAt(0)){for(I=J.root.split("/"),t="",s=0;s<I.length-1;s++)t+=I[s]+"/";t+=J.key,J.root=t,J.location=""}T.push(J)}}else T.push(J)}S=T.length;for(var C=0;C<T.length;C++)!function(e,r,i){if(null===e.root||e.root===n)i.resolveItem(r,a,g,u,y,e),c+=1,c===S&&i.finish(r,n,g,u,y,l);else{var o={useJQuery:!1,url:e.root,method:"get",headers:{accept:i.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){c+=1,y[e.key]={root:e.root,location:e.location},c===S&&i.finish(r,a,g,u,y,l)},response:function(o){var t=o.obj;i.resolveItem(t,e.root,g,u,y,e),c+=1,c===S&&i.finish(r,a,g,u,y,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(o),(new SwaggerHttp).execute(o)}}(T[C],e,this);0===Object.keys(T).length&&this.finish(e,a,g,u,y,l)},Resolver.prototype.resolveItem=function(e,r,i,o,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?o[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,r,i,o,t,s){var n;for(n in i){var l=i[n],f=l.key,a=o[f];if(a)if(e.definitions=e.definitions||{},"ref"===l.resolveAs){for(f in a.obj)var p=this.retainRoot(a.obj[f],l.root);e.definitions[a.name]=a.obj,l.obj.$ref="#/definitions/"+a.name}else if("inline"===l.resolveAs){var h=l.obj;h["x-resolved-from"]=[l.key],delete h.$ref;for(f in a.obj){var p=this.retainRoot(a.obj[f],l.root);h[f]=p}}}var v=this.countUnresolvedRefs(e);0===v.length||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,r,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var r,i=this.getRefs(e),o=[],t=[];for(r in i)0===r.indexOf("#")?o.push(r.substring(1)):t.push(r);for(r=0;r<o.length;r++)for(var s=o[r],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,r){r=r||e;var i={};for(var o in r)if(r.hasOwnProperty(o)){var t=r[o];if("$ref"===o&&"string"==typeof t)i[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)i[n]=null}}return i},Resolver.prototype.retainRoot=function(e,r){for(var i in e){var o=e[i];"$ref"===i&&"string"==typeof o?0!==o.indexOf("http://")&&0!==o.indexOf("https://")&&(0!==o.indexOf("#")&&(o="#"+o),o=(r||"")+o,e[i]=o):_.isObject(o)&&this.retainRoot(o,r)}return e},Resolver.prototype.resolveInline=function(e,r,i,o,t,s){var n,l,f,a,p=i.$ref,h=i.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var d=0;d<f.length;d++)d>0&&(e+="/"),e+=f[d]}e+="/"+h.split("#")[0]}s=a[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),o.push({obj:i,resolveAs:"inline",root:e,key:p,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],o.push({obj:i,resolveAs:"inline",root:e,key:p,location:s})):o.push({obj:i,resolveAs:"inline",root:e,key:p,location:s})}else"array"===i.type&&this.resolveTo(e,i.items,o,s)},Resolver.prototype.resolveTo=function(e,r,i,o){var t,s,n=r.$ref,l=e;if("undefined"!=typeof n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}o=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,o="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,o=""}i.push({obj:r,resolveAs:"ref",root:l,key:n,location:o})}else if("array"===r.type){var a=r.items;this.resolveTo(e,a,i,o)}else if(r&&r.properties){var p=this.uniqueName("inline_model");this.spec.definitions[p]=_.cloneDeep(r),r.$ref="#/definitions/"+p,delete r.type,delete r.properties}},Resolver.prototype.uniqueName=function(e){for(var r=e,i=0;;){if(!_.isObject(this.spec.definitions[r]))return r;r=e+"_"+i,i++}},Resolver.prototype.resolveAllOf=function(e,r,i){i=i||0,r=r||e;var o;for(var t in r)if(r.hasOwnProperty(t)){var s=r[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+r+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,i+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l={};l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]),l.properties={},s.example&&(l.example=s.example);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(o in v){l.properties[o]=JSON.parse(JSON.stringify(v[o]));var d=v[o]["x-resolved-from"];("undefined"==typeof d||"self"===d)&&(d=p),l.properties[o]["x-resolved-from"]=d}}else if("required"===h){for(var c=l.required.concat(a[h]),u=0;u<c.length;++u)for(var y=u+1;y<c.length;++y)c[u]===c[y]&&c.splice(y--,1);l.required=c}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=JSON.parse(JSON.stringify(a[h])),"properties"===h)for(o in l[h])l[h][o]["x-resolved-from"]=p}r[t]=l}}_.isObject(s)&&this.resolveAllOf(e,s,i+1)}};
...
},{"../schema-markup.js":7,"js-yaml":19,"lodash-compat/lang/isPlainObject":146,"lodash-compat/lang/isString":147}],10:[function(require,module,exports){
"use strict";function itemByPriority(e,t){if(_.isEmpty(t))return e[0];for(var r=0,n=t.length;n>r;r++)if(e.indexOf(t[r])>-1)return t[r];return e[0]}var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),isUndefined:require("lodash-compat/lang/isUndefined"),isEmpty:require("lodash-compat/lang/isEmpty"),isObject:require("lodash-compat/lang/isObject")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Q=require("q"),Operation=module.exports=function(e,t,r,n,s,i,o,a,p){var l=[];if(e=e||{},i=i||{},e&&e.options&&(this.client=e.options.client||null,this.responseInterceptor=e.options.responseInterceptor||null),this.authorizations=i.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=i.consumes||e.consumes||["application/json"],this.produces=i.produces||e.produces||["application/json"],this.deprecated=i.deprecated,this.description=i.description,this.host=e.host||"localhost",this.method=n||l.push("Operation "+r+" is missing method."),this.models=a||{},this.nickname=r||l.push("Operations must have a nickname."),this.operation=i,this.operations={},this.parameters=null!==i?i.parameters||[]:{},this.parent=e,this.path=s||l.push("Operation "+this.nickname+" is missing path."),this.responses=i.responses||{},this.scheme=t||e.scheme||"http",this.schemes=i.schemes||e.schemes,this.security=i.security,this.summary=i.summary||"",this.type=null,this.useJQuery=e.useJQuery,this.parameterMacro=e.parameterMacro||function(e,t){return t["default"]},this.inlineModels=[],"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var u,h;if(o){var d;for(d in o)h=new Model(d,o[d],this.models,e.modelPropertyMacro),h&&(this.models[d]=h)}else o={};for(u=0;u<this.parameters.length;u++){var c=this.parameters[u];c["default"]=this.parameterMacro(this,c),"array"===c.type&&(c.isList=!0,c.allowMultiple=!0);var f=this.getType(c);if(f&&"boolean"===f.toString().toLowerCase()&&(c.allowableValues={},c.isList=!0,c["enum"]=[!0,!1]),c["x-examples"]){var m=c["x-examples"]["default"];"undefined"!=typeof m&&(c["default"]=m)}if("undefined"!=typeof c["enum"]){var y;for(c.allowableValues={},c.allowableValues.values=[],c.allowableValues.descriptiveValues=[],y=0;y<c["enum"].length;y++){var g=c["enum"][y],v=g===c["default"]||g+""===c["default"];c.allowableValues.values.push(g),c.allowableValues.descriptiveValues.push({value:g+"",isDefault:v})}}"array"===c.type&&(f=[f],"undefined"==typeof c.allowableValues&&(delete c.isList,delete c.allowMultiple)),c.signature=this.getModelSignature(f,this.models).toString(),c.sampleJSON=this.getModelSampleJSON(f,this.models),c.responseClassSignature=c.signature}var O,b,M=this.responses;if(M[200]?(b=M[200],O="200"):M[201]?(b=M[201],O="201"):M[202]?(b=M[202],O="202"):M[203]?(b=M[203],O="203"):M[204]?(b=M[204],O="204"):M[205]?(b=M[205],O="205"):M[206]?(b=M[206],O="206"):M["default"]&&(b=M["default"],O="default"),b&&b.schema){var P,C=this.resolveModel(b.schema,o);delete M[O],C?(this.successResponse={},P=this.successResponse[O]=C):b.schema.type&&"object"!==b.schema.type&&"array"!==b.schema.type?(this.successResponse={},P=this.successResponse[O]=b.schema):(this.successResponse={},P=this.successResponse[O]=new Model(void 0,b.schema||{},this.models,e.modelPropertyMacro)),P&&(b.description&&(P.description=b.description),b.examples&&(P.examples=b.examples),b.headers&&(P.headers=b.headers)),this.type=b}return l.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(l),this};Operation.prototype.isDefaultArrayItemValue=function(e,t){return t["default"]&&Array.isArray(t["default"])?-1!==t["default"].indexOf(e):e===t["default"]},Operation.prototype.getType=function(e){var t,r=e.type,n=e.format,s=!1;"integer"===r&&"int32"===n?t="integer":"integer"===r&&"int64"===n?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===n?"date-time":"date"===n?"date":"string":"number"===r&&"float"===n?t="float":"number"===r&&"double"===n?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r&&(s=!0,e.items&&(t=this.getType(e.items))),e.$ref&&(t=helpers.simpleRef(e.$ref));var i=e.schema;if(i){var o=i.$ref;return o?(o=helpers.simpleRef(o),s?[o]:o):"object"===i.type?this.addInlineModel(i):this.getType(i)}return s?[t]:t},Operation.prototype.addInlineModel=function(e){var t=this.inlineModels.length,r=this.resolveModel(e,{});return r?(this.inlineModels.push(r),"Inline Model "+t):null},Operation.prototype.getInlineModel=function(e){if(/^Inline Model \d+$/.test(e)){var t=parseInt(e.substr("Inline Model".length).trim(),10),r=this.inlineModels[t];return r}return null},Operation.prototype.resolveModel=function(e,t){if("undefined"!=typeof e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models,this.parent.modelPropertyMacro)}else if(e&&"object"==typeof e&&("object"===e.type||_.isUndefined(e.type)))return new Model(void 0,e,this.models,this.parent.modelPropertyMacro);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var n=this.parameters[r],s=n.signature;t+="\n  * "+n.name+" ("+s+"): "+n.description}return"undefined"==typeof e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,n;return e instanceof Array&&(n=!0,e=e[0]),"undefined"==typeof e?(e="undefined",r=!0):t[e]?(e=t[e],r=!1):this.getInlineModel(e)?(e=this.getInlineModel(e),r=!1):r=!0,r?n?"Array["+e+"]":e.toString():n?"Array["+e.getMockSignature()+"]":e.getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r=0;r<this.parameters.length;r++){var n=this.parameters[r];if("undefined"!=typeof e[n.name]&&"header"===n["in"]){var s=e[n.name];Array.isArray(s)&&(s=s.toString()),t[n.name]=s}}return t},Operation.prototype.urlify=function(e){for(var t={},r=this.path,n="",s=0;s<this.parameters.length;s++){var i=this.parameters[s];if("undefined"!=typeof e[i.name])if("path"===i["in"]){var o=new RegExp("{"+i.name+"}","gi"),a=e[i.name];a=Array.isArray(a)?this.encodePathCollection(i.collectionFormat,i.name,a):this.encodePathParam(a),r=r.replace(o,a)}else if("query"===i["in"]&&"undefined"!=typeof e[i.name])if(n+=""===n?"?":"&","undefined"!=typeof i.collectionFormat){var p=e[i.name];n+=Array.isArray(p)?this.encodeQueryCollection(i.collectionFormat,i.name,p):this.encodeQueryParam(i.name)+"="+this.encodeQueryParam(e[i.name])}else n+=this.encodeQueryParam(i.name)+"="+this.encodeQueryParam(e[i.name]);else"formData"===i["in"]&&(t[i.name]=e[i.name])}var l=this.scheme+"://"+this.host;return"/"!==this.basePath&&(l+=this.basePath),l+r+n},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var n=this.parameters[t];n.required===!0&&"undefined"==typeof e[n.name]&&(r=n.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var n,s,i,o,a={},p=!1,l=0;l<this.parameters.length;l++){var u=this.parameters[l];"undefined"!=typeof t[u.name]?"body"===u["in"]?s=t[u.name]:"formData"===u["in"]&&(a[u.name]=t[u.name],n=!0):"body"===u["in"]&&(p=!0)}if(p&&"undefined"==typeof s){var h=e["Content-Type"];h&&0===h.indexOf("application/json")&&(s="{}")}if(n){var d="";for(i in a)o=a[i],"undefined"!=typeof o&&(""!==d&&(d+="&"),d+=encodeURIComponent(i)+"="+encodeURIComponent(o));s=d}else if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&r.useJQuery){var c=new FormData;c.type="formData";for(i in a)o=t[i],"undefined"!=typeof o&&("file"===o.type&&o.value?(delete e["Content-Type"],c.append(i,o.value)):c.append(i,o));s=c}return s},Operation.prototype.getModelSampleJSON=function(e,t){var r,n,s;if(t=t||{},r=e instanceof Array,s=r?e[0]:e,t[s]?n=t[s].createJSONSample():this.getInlineModel(s)&&(n=this.getInlineModel(s).createJSONSample()),n){if(n=r?[n]:n,"string"==typeof n)return n;if(_.isObject(n)){var i=n;if(n instanceof Array&&n.length>0&&(i=n[0]),i.nodeName&&"Node"==typeof i){var o=(new XMLSerializer).serializeToString(i);return this.formatXml(o)}return JSON.stringify(n,null,2)}return n}},Operation.prototype["do"]=function(e,t,r,n,s){return this.execute(e,t,r,n,s)},Operation.prototype.execute=function(e,t,r,n,s){var i,o,a,p=e||{},l={};_.isObject(t)&&(l=t,i=r,o=n),this.client&&(l.client=this.client),!l.requestInterceptor&&this.requestInterceptor&&(l.requestInterceptor=this.requestInterceptor),!l.responseInterceptor&&this.responseInterceptor&&(l.responseInterceptor=this.responseInterceptor),"function"==typeof t&&(i=t,o=r),this.parent.usePromise?a=Q.defer():(i=i||this.parent.defaultSuccessCallback||helpers.log,o=o||this.parent.defaultErrorCallback||helpers.log),"undefined"==typeof l.useJQuery&&(l.useJQuery=this.useJQuery);var u=this.getMissingParams(p);if(u.length>0){var h="missing required params: "+u;return helpers.fail(h),this.parent.usePromise?(a.reject(h),a.promise):(o(h),{})}var d,c=this.getHeaderParams(p),f=this.setContentTypes(p,l),m={};for(d in c)m[d]=c[d];for(d in f)m[d]=f[d];var y=this.getBody(f,p,l),g=this.urlify(p);if(g.indexOf(".{format}")>0&&m){var v=m.Accept||m.accept;v&&v.indexOf("json")>0?g=g.replace(".{format}",".json"):v&&v.indexOf("xml")>0&&(g=g.replace(".{format}",".xml"))}var O={url:g,method:this.method.toUpperCase(),body:y,useJQuery:l.useJQuery,deferred:a,headers:m,on:{response:function(e){return a?(a.resolve(e),a.promise):i(e,s)},error:function(e){return a?(a.reject(e),a.promise):o(e,s)}}};return this.clientAuthorizations.apply(O,this.operation.security),l.mock===!0?O:(new SwaggerHttp).execute(O,l)},Operation.prototype.setContentTypes=function(e,t){var r,n,s=this.parameters,i=e.parameterContentType||itemByPriority(this.consumes,["application/json","application/yaml"]),o=t.responseContentType||itemByPriority(this.produces,["application/json","application/yaml"]),a=[],p=[],l={};for(n=0;n<s.length;n++){var u=s[n];if("formData"===u["in"])"file"===u.type?a.push(u):p.push(u);else if("header"===u["in"]&&t){var h=u.name,d=t[u.name];"undefined"!=typeof t[u.name]&&(l[h]=d)}else"body"===u["in"]&&"undefined"!=typeof e[u.name]&&(r=e[u.name])}return"post"===this.method||"put"===this.method||"patch"===this.method||("delete"===this.method||"get"===this.method)&&r?(t.requestContentType&&(i=t.requestContentType),p.length>0&&(i=t.requestContentType?t.requestContentType:a.length>0?"multipart/form-data":"application/x-www-form-urlencoded")):i=null,i&&this.consumes&&-1===this.consumes.indexOf(i)&&helpers.log("server doesn't consume "+i+", try "+JSON.stringify(this.consumes)),this.matchesAccept(o)||helpers.log("server can't produce "+o),(i&&""!==r||"application/x-www-form-urlencoded"===i)&&(l["Content-Type"]=i),o&&(l.Accept=o),l},Operation.prototype.matchesAccept=function(e){return e&&this.produces?-1!==this.produces.indexOf(e)||-1!==this.produces.indexOf("*/*"):!0},Operation.prototype.asCurl=function(e,t){var r={mock:!0};if("object"==typeof t)for(var n in t)r[n]=t[n];var s=this.execute(e,r);this.clientAuthorizations.apply(s,this.operation.security);var i=[];if(i.push("-X "+this.method.toUpperCase()),"undefined"!=typeof s.headers){var o;for(o in s.headers){var a=s.headers[o];"string"==typeof a&&(a=a.replace(/\'/g,"\\u0027")),i.push("--header '"+o+": "+a+"'")}}if(s.body){var p;p=_.isObject(s.body)?JSON.stringify(s.body):s.body,i.push("-d '"+p.replace(/\'/g,"\\u0027")+"'")}return"curl "+i.join(" ")+" '"+s.url+"'"},Operation.prototype.encodePathCollection=function(e,t,r){var n,s="",i="";for(i="ssv"===e?"%20":"tsv"===e?"\\t":"pipes"===e?"|":",",n=0;n<r.length;n++)0===n?s=this.encodeQueryParam(r[n]):s+=i+this.encodeQueryParam(r[n]);return s},Operation.prototype.encodeQueryCollection=function(e,t,r){var n,s="";if("default"===e||"multi"===e)for(n=0;n<r.length;n++)n>0&&(s+="&"),s+=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[n]);else{var i="";if("csv"===e)i=",";else if("ssv"===e)i="%20";else if("tsv"===e)i="\\t";else if("pipes"===e)i="|";else if("brackets"===e)for(n=0;n<r.length;n++)0!==n&&(s+="&"),s+=this.encodeQueryParam(t)+"[]="+this.encodeQueryParam(r[n]);if(""!==i)for(n=0;n<r.length;n++)0===n?s=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[n]):s+=i+this.encodeQueryParam(r[n])}return s},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)},Operation.prototype.encodePathParam=function(e){return encodeURIComponent(e)};
...
},{"../type":32,"buffer":12}],34:[function(require,module,exports){
...
},{"../../type":32,"esprima":49}],38:[function(require,module,exports){
...
},{"../internal/baseIndexOf":79,"../internal/binaryIndex":93}],51:[function(require,module,exports){
...
},{"../internal/LazyWrapper":61,"../internal/LodashWrapper":62,"../internal/baseLodash":83,"../internal/isObjectLike":127,"../internal/wrapperClone":138,"../lang/isArray":141}],53:[function(require,module,exports){
module.exports=require("./forEach");


},{"./forEach":55}],54:[function(require,module,exports){
...
},{"../internal/baseEach":72,"../internal/createFind":103}],55:[function(require,module,exports){
...
},{"../internal/arrayEach":64,"../internal/baseEach":72,"../internal/createForEach":104}],56:[function(require,module,exports){
...
},{"../internal/baseIndexOf":79,"../internal/getLength":113,"../internal/isIterateeCall":123,"../internal/isLength":126,"../lang/isArray":141,"../lang/isString":147,"../object/values":153}],57:[function(require,module,exports){
...
},{"../internal/arrayMap":65,"../internal/baseCallback":68,"../internal/baseMap":84,"../lang/isArray":141}],58:[function(require,module,exports){
...
},{"../internal/getNative":115}],59:[function(require,module,exports){
...
},{"../internal/createWrapper":107,"../internal/replaceHolders":133,"./restParam":60}],60:[function(require,module,exports){
...
},{"./baseCreate":71,"./baseLodash":83}],62:[function(require,module,exports){
...
},{"./baseCreate":71,"./baseLodash":83}],63:[function(require,module,exports){
...
},{"../object/keys":150,"./baseCopy":70}],68:[function(require,module,exports){
...
},{"../utility/identity":155,"../utility/property":157,"./baseMatches":85,"./baseMatchesProperty":86,"./bindCallback":95}],69:[function(require,module,exports){
...
},{"../lang/isArray":141,"../lang/isObject":145,"./arrayCopy":63,"./arrayEach":64,"./baseAssign":67,"./baseForOwn":77,"./initCloneArray":117,"./initCloneByTag":118,"./initCloneObject":119,"./isHostObject":121}],70:[function(require,module,exports){
...
},{"../lang/isObject":145}],72:[function(require,module,exports){
...
},{"./baseForOwn":77,"./createBaseEach":99}],73:[function(require,module,exports){
...
},{"./createBaseFor":100}],76:[function(require,module,exports){
...
},{"../object/keysIn":151,"./baseFor":75}],77:[function(require,module,exports){
...
},{"../object/keys":150,"./baseFor":75}],78:[function(require,module,exports){
...
},{"./toObject":136}],79:[function(require,module,exports){
...
},{"./indexOfNaN":116}],80:[function(require,module,exports){
...
},{"../lang/isObject":145,"./baseIsEqualDeep":81,"./isObjectLike":127}],81:[function(require,module,exports){
...
},{"../lang/isArray":141,"../lang/isTypedArray":148,"./equalArrays":108,"./equalByTag":109,"./equalObjects":110,"./isHostObject":121}],82:[function(require,module,exports){
...
},{"./baseIsEqual":80,"./toObject":136}],83:[function(require,module,exports){
...
},{"./baseEach":72,"./isArrayLike":120}],85:[function(require,module,exports){
...
},{"./baseIsMatch":82,"./getMatchData":114,"./toObject":136}],86:[function(require,module,exports){
...
},{"../array/last":51,"../lang/isArray":141,"./baseGet":78,"./baseIsEqual":80,"./baseSlice":90,"./isKey":124,"./isStrictComparable":128,"./toObject":136,"./toPath":137}],87:[function(require,module,exports){
...
},{"./toObject":136}],88:[function(require,module,exports){
...
},{"./baseGet":78,"./toPath":137}],89:[function(require,module,exports){
...
},{"../utility/identity":155,"./metaMap":130}],90:[function(require,module,exports){
...
},{"../utility/identity":155,"./binaryIndexBy":94}],94:[function(require,module,exports){
...
},{"../utility/identity":155}],96:[function(require,module,exports){
(function (global){
...
},{"./getLength":113,"./isLength":126,"./toObject":136}],100:[function(require,module,exports){
...
},{"./toObject":136}],101:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":102}],102:[function(require,module,exports){
...
},{"../lang/isObject":145,"./baseCreate":71}],103:[function(require,module,exports){
...
},{"../lang/isArray":141,"./baseCallback":68,"./baseFind":73,"./baseFindIndex":74}],104:[function(require,module,exports){
...
},{"../lang/isArray":141,"./bindCallback":95}],105:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":63,"./composeArgs":97,"./composeArgsRight":98,"./createCtorWrapper":102,"./isLaziable":125,"./reorder":132,"./replaceHolders":133,"./setData":134}],106:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":102}],107:[function(require,module,exports){
...
},{"./baseSetData":89,"./createBindWrapper":101,"./createHybridWrapper":105,"./createPartialWrapper":106,"./getData":111,"./mergeData":129,"./setData":134}],108:[function(require,module,exports){
...
},{"./arraySome":66}],109:[function(require,module,exports){
...
},{"../object/keys":150}],111:[function(require,module,exports){
...
},{"../utility/noop":156,"./metaMap":130}],112:[function(require,module,exports){
...
},{"./realNames":131}],113:[function(require,module,exports){
var baseProperty=require("./baseProperty"),getLength=baseProperty("length");module.exports=getLength;


},{"./baseProperty":87}],114:[function(require,module,exports){
...
},{"../object/pairs":152,"./isStrictComparable":128}],115:[function(require,module,exports){
...
},{"../lang/isNative":144}],116:[function(require,module,exports){
...
},{"./bufferClone":96}],119:[function(require,module,exports){
...
},{"./getLength":113,"./isLength":126}],121:[function(require,module,exports){
...
},{"../lang/isObject":145,"./isArrayLike":120,"./isIndex":122}],124:[function(require,module,exports){
...
},{"../lang/isArray":141,"./toObject":136}],125:[function(require,module,exports){
...
},{"../chain/lodash":52,"./LazyWrapper":61,"./getData":111,"./getFuncName":112}],126:[function(require,module,exports){
...
},{"../lang/isObject":145}],129:[function(require,module,exports){
...
},{"./arrayCopy":63,"./composeArgs":97,"./composeArgsRight":98,"./replaceHolders":133}],130:[function(require,module,exports){
(function (global){
var getNative=require("./getNative"),WeakMap=getNative(global,"WeakMap"),metaMap=WeakMap&&new WeakMap;module.exports=metaMap;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./getNative":115}],131:[function(require,module,exports){
...
},{"./arrayCopy":63,"./isIndex":122}],133:[function(require,module,exports){
...
},{"../date/now":58,"./baseSetData":89}],135:[function(require,module,exports){
...
},{"../lang/isArguments":140,"../lang/isArray":141,"../lang/isString":147,"../object/keysIn":151,"./isIndex":122,"./isLength":126}],136:[function(require,module,exports){
...
},{"../lang/isObject":145,"../lang/isString":147,"../support":154}],137:[function(require,module,exports){
...
},{"../lang/isArray":141,"./baseToString":91}],138:[function(require,module,exports){
...
},{"./LazyWrapper":61,"./LodashWrapper":62,"./arrayCopy":63}],139:[function(require,module,exports){
...
},{"../internal/baseClone":69,"../internal/bindCallback":95}],140:[function(require,module,exports){
...
},{"../internal/isArrayLike":120,"../internal/isObjectLike":127}],141:[function(require,module,exports){
...
},{"../internal/getNative":115,"../internal/isLength":126,"../internal/isObjectLike":127}],142:[function(require,module,exports){
...
},{"../internal/isArrayLike":120,"../internal/isObjectLike":127,"../object/keys":150,"./isArguments":140,"./isArray":141,"./isFunction":143,"./isString":147}],143:[function(require,module,exports){
...
},{"../internal/isHostObject":121,"../internal/isObjectLike":127,"./isFunction":143}],145:[function(require,module,exports){
...
},{"../internal/baseForIn":76,"../internal/isHostObject":121,"../internal/isObjectLike":127,"../support":154,"./isArguments":140}],147:[function(require,module,exports){
...
},{"../internal/isObjectLike":127}],148:[function(require,module,exports){
...
},{"../internal/isLength":126,"../internal/isObjectLike":127}],149:[function(require,module,exports){
...
},{"../internal/getNative":115,"../internal/isArrayLike":120,"../internal/shimKeys":135,"../lang/isObject":145,"../support":154}],151:[function(require,module,exports){
...
},{"../internal/arrayEach":64,"../internal/isIndex":122,"../internal/isLength":126,"../lang/isArguments":140,"../lang/isArray":141,"../lang/isFunction":143,"../lang/isObject":145,"../lang/isString":147,"../support":154}],152:[function(require,module,exports){
...
},{"../internal/toObject":136,"./keys":150}],153:[function(require,module,exports){
...
},{"../internal/baseValues":92,"./keys":150}],154:[function(require,module,exports){
...
},{"../internal/baseProperty":87,"../internal/basePropertyDeep":88,"../internal/isKey":124}],158:[function(require,module,exports){
(function (process){
...
},{"_process":undefined}],159:[function(require,module,exports){
